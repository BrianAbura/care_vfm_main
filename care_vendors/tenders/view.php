        ...
        <div class="boxed">
            <div id="content-container">
                <div id="page-head">
					...
					<li class="active">View Tender Details</li>
                    </ol>
                    </div>
                </div>
        ...
        <div class="fixed-fluid">
            ...
            <div class="panel">
                ...
                <div class="blog-footer">
                    ...
                    <span class="mar-rgt"><a href="javascript:history.back()" class="btn btn-danger btn-md">Cancel</a></span>
                    </div>
                    <div class="media-body text-right">
                        <?php 
                        if(check_vendor_status($vendor_id)){ //Only Active vendors can submit applications
                        if(checkTenderApplication($tender_id, $vendor_id)){ //If application is sent already
                            $tenderStatus = TenderApplicationStatus($tender_id, $vendor_id);
                            if($tenderStatus == 1){ //Draft
                        ?>
                            <span class="mar-rgt"><a href="<?php echo $tender_id."-draft"?>" class="btn btn-mint btn-md">Resume Application</a></span>
                            <p class="help-block text-purple"><i>Draft Application saved for this tender.</i></p>
                        <?php 
                            }
                            else{ //Final
                        ?>
                            <span class="mar-rgt"><a href="<?php echo $tender_id."-submitted"?>" class="btn btn-success btn-md">View Application</a></span>
                            <p class="help-block text-purple"><i>Application submitted for this tender.</i></p>
                        <?php 
                            }
                        } 
                        else{
                        ?>
                        <span class="mar-rgt"><a href="<?php echo $tender_id."-submit"?>" class="btn btn-info btn-md">Submit Application</a></span>
                        <?php } } ?>
                    </div>
                </div>
            </div>
