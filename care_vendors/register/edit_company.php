...
-->
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="registration_num" placeholder="Business Registration Number" autocomplete="off" value="<?php echo $vendor['registration_num'];?>">
            </div>
            </div>
            <div class="col-sm-3">
            <div class="form-group">
