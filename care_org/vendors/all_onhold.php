...
<ol class="breadcrumb">
<li></li>
<li class="active text-lg">Vendors On-Hold</li>
</ol>
</div>
					...
					<div class="tab-content">
						...
						<div class="table-responsive">
									<table id="active_vendors_table" class="table table-vcenter mar-top" width="100%">
										...
										<?php 
										$cnt = 1;
										$vendors = DB::query('SELECT * from vendors where vendor_status=%s order by id desc',4);
										...
										<td><button class="btn btn-warning btn-sm text-bold">On-Hold</button></td>
