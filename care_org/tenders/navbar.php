        ...
        <header id="navbar">
            <div id="navbar-container" class="boxed">
                ...
                <li class="tgl-menu-btn">
                    ...
                    <h4 class="page-header" style="color:#fff">Tenders</h4>
                    </a>
                </li>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        ...
        ?>
            ...
            <a href="../tenders">
                ...
                <ul class="collapse in">
                    <li class="active-link"><a href="../tenders">Approved Requisitions</a></li>
                    <li><a href="pending">Pending Tenders</a></li>
                    <li><a href="published">Published Tenders</a></li>
                </ul>
            </li>
            <br/>
			<li>
