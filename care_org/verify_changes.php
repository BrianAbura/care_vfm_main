...
<head>
    ...
    <title>User Verification | Care Uganda</title>
...
$user = DB::queryFirstRow('SELECT * from org_users where email_address=%s', $email);
$role = DB::queryFirstRow('SELECT * from org_roles where id=%s', $user['role_id']);
?>
		    <div class="cls-content-sm panel">
		        <div class="panel-body">
		            <div class="mar-ver pad-btm">
                        <p class="text-bold">Welcome</p>
		                <h4 class=" text-dark"><?php echo $user['first_name']." ".$user['last_name'];?></h4>
		        ...
		        <div class="pad-all text-left">
		            ...
		            <div class="media pad-top bord-top">
		                <div class="text-center text-warning">
		                    * This interface is inteded for Staff only
		                </div>
		            </div>
					<hr/>
		        </div>
