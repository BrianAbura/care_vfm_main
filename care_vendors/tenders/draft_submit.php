...
<head>
    ...
    <title>Tender Draft Submit | Care Uganda</title>
    <?php 
...
<div id="page-content">
        <div class="fixed-fluid">
            ...
            <div class="panel">
            <form id="demo-bv-bsc-tabs" action="send_draft" method="POST" enctype="multipart/form-data">
            ...
            <input type="hidden" name="tender_id" value="<?php echo $tender_id;?>">
                ...
                <table class="table table-bordered table-striped pad-ver mar-no">
                    ...
                    <td class="text-bold text-lg" style="color:#FF8C00" colspan="4">Preliminary Criteria</td>
                        ...
                        ?>
                        <tr>
                        <input type="hidden" class="form-control" name="pre_resp_id[]" value="<?php echo $response['id'];?>">
                        ...
                        <td><textarea placeholder="Type Response here.." class="form-control" name="pre_vendor_resp[]"><?php echo $response['vendor_response']; ?></textarea></td>
                        </tr>
                        <tr>
                        ...
                        <td>
                            ...
                            if($attachment != null){
                            ?>
                            <a href="<?php echo $attachment;?>" target="_blank" class="btn-link"><i class="fa fa-cloud-download icon-2x icon-fw"></i>View Attached file</a><br/>
                            <?php } ?>
                        </td>
                        </tr>
                        <?php
                    ...
                    ?>
                        ...
                        ?>
                        <tr>
                        <input type="hidden" class="form-control" name="tech_resp_id[]" value="<?php echo $response['id'];?>">
                        ...
                        <tr>
                        <th style="width:15%">Response:</th>
                        <td><textarea placeholder="Type Response here.." class="form-control" name="tech_vendor_resp[]"><?php echo $response['vendor_response']; ?></textarea></td>
                        </tr>
                        <tr>
                        <th>Support Document:</th>
                        <td>
             ...
             <table id="requisition_item_table" class="table table-bordered table-striped pad-ver mar-no">
                <tbody>
                    ...
                    ?>
                        ...
                        <input type="hidden" class="form-control" name="finance_resp_id[]" value="<?php echo $amt_resp['id'];?>">
                        ...
                        <td><input type="text" id="item_unit_price" class="form-control item_price var_prices" name="finance_vendor_resp[]" value="<?php echo number_format($unit_price);?>"/></td>
                        <td><input type="text" id="item_total_price" class="form-control prices var_prices item_total_price" disabled name="item_total_price[]" value="<?php echo number_format($total);?>"/></td>
                        </tr>
                        <?php
                            $sub_total += $total;
                            $cnt++;
                        ...
                        ?>
                            ...
                            <td class="text-dark"><input type="text" class="form-control prices" id="items_total_value" name="items_total_value" readonly value="<?php echo number_format($sub_total);?>"/></td>
                            </tr>
                                <!-- SUb Total-->
                            <tr>
                            <td></td><td></td>
                            ...
                            <td class="text-dark"><input type="number" max="100" class="form-control items_vat" id="items_vat" name="vat_vendor_resp" value="<?php echo $vat;?>"/></td>
                            </tr>
                            ...
                            <td class="text-dark"><input type="text" class="form-control prices text-lg text-bold" id="items_grand_total" name="items_grand_total" readonly value="<?php echo number_format($grand_total);?>"/></td>
                            </tr>
