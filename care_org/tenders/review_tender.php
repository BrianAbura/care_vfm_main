...
<ol class="breadcrumb">
<li></li>
<li class="active text-lg">Review Tender Details</li>
</ol>
</div>
...
?>
				...
				<div class="panel-body">
                    ...
                    <h4 style="color:teal;">Tender - #<?php echo $tender_id;?></h4><br/>
                        <tbody>
                            <tr>
				...
				<div class="col-lg-12">
                    ...
                    <table class="table table-bordered table-striped pad-ver mar-no">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-info text-bold col-md-2">Shortlisted Vendors</td>
                    ...
                    <div class="col-lg-6">
						...
						<tr>
							...
							<tbody>
								...
								?>
                                    <tr>
                                    <td width="10%"><p class="form-control prices"><?php echo $cnt;?></p></td>	
                    ...
                    <div class="col-lg-6">
                        ...
                        <h4><span class="text-warning"><i class="ti-ruler-pencil icon-2x"></i></span> Techincal Evaluation Criteria</h4><br/>
						<div>
						<table class="table table-bordered">
						<thead>
						<tr>
					...
					<tr>
                        ...
                        <td><p class="form-control prices"><?php echo $unspsc['description'];?></p></td>
					...
					$cnt ++;  
						...
						<div class="col-sm-12" style=" border: 0.4px solid rgb(255, 158, 48);">
						<?php 
                        ...
                        <hr/>
                        <h4><span class="text-info"><i class="ti-pencil-alt icon-2x"></i></span> Tender Review</h4><br/>
                        <form id="demo-bv-bsc-tabs" action="tender_review" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="tender_id" value="<?php echo $tender_id; ?>">
                        <input type="hidden" name="review_type" value="smt_review">

                        <div class="row">
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <label class="control-label">Decision</label>
                                    <select class="selectpicker form-control" data-live-search="true" name="decision" required>
                                        <option></option>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Comments.." rows="4" class="form-control" name="narration"></textarea>
                                </div>
                            </div>
                            </div>
                            <br/>
                            ...
                            <div class="tab-footer clearfix">	
                                <a href="../tenders/pending" class="btn btn-danger">Cancel</a>	
