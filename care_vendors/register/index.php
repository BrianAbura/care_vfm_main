    ...
    <div id="container" class="effect aside-float aside-bright mainnav-sm page-fixedbar">
        ...
        <div class="boxed">
            <div id="content-container">
                <div id="page-head">
                    <div id="page-title">
                        <h1 class="page-header text-overflow">Company/Organisation Registration</h1>
						<ol class="breadcrumb">
...
<!--Form-->
<form id="demo-bv-wz-form" action="add_company" method="POST" enctype="multipart/form-data">
<input type="hidden" name="token" value="add_vendor">
<input type="hidden" name="vendor_type" value="Company/Organisation">
...
-->
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="vendor_name" placeholder="Registered Name" autocomplete="off" required>
            </div>
            </div>
            <div class="col-sm-3">
            <div class="form-group">
                <label class="control-label">Business Registration Number</label>
                <input type="text" class="form-control" name="registration_num" placeholder="Business Registration Number" autocomplete="off" required>
            </div>
            </div>
            <div class="col-sm-3">
            <div class="form-group">
                <label class="control-label">Tax Identification Number</label>
                <input type="text" class="form-control" name="tin_num" placeholder="TIN/Equivalent" autocomplete="off">
            </div>
            </div>
            <div class="col-sm-3">
            <div class="form-group">
                <label class="control-label">Email Address</label>
                <input type="email" class="form-control" name="email_address" placeholder="Business Email" autocomplete="off">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <textarea placeholder="" rows="3" class="form-control" name="street_address"></textarea>
            </div>
            </div>
        <div class="col-sm-4">
            <div class="form-group">
                <label class="control-label">Postal Address</label>
                <textarea placeholder="" rows="3" class="form-control" name="postal_address"></textarea>
            </div>
            </div>
            <div class="col-sm-4">
            <div class="form-group">
        ...
        <label class="control-label">Business Sub-Categories:</label>
            ...
            <option></option>
                <?php 
                $codes = DB::query('SELECT * from unspsc order by description');
...
-->
        <div id="demo-cls-tab2" class="tab-pane fade">
            ...
            <label class="control-label">Logo</label> 
                ...
                <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label">Certificate of Registration</label> 
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="input-append">
                            <div class="uneditable-input">
                            <span class="fileupload-preview" style="font-size: 12px; color:blue"></span>
                            ...
                            <span class="btn btn-md btn-mint fa fa-edit fileupload-exists" title="Change Attachment"></span>
                            <span class="fileupload-new btn btn-primary fa fa-upload"> Select file</span>
                            <input type="file" id="InputReceiptImg" name="reg_cert" onchange="ValidateSingleInput(this);" required/>
                            </span>
                            <a href="#" class="btn btn-md btn-danger demo-pli-trash fileupload-exists" title="Remove Attachment" data-dismiss="fileupload"></a>
                ...
                <div class="form-group">
                    <label class="control-label">Business Operation License</label> 
                        ...
                        <div class="input-append">
                            ...
                            <span class="btn btn-md btn-mint fa fa-edit fileupload-exists" title="Change Attachment"></span>
                            <span class="fileupload-new btn btn-primary fa fa-upload"> Select file</span>
                            <input type="file" id="InputReceiptImg" name="trade_license" onchange="ValidateSingleInput(this);" required/>
                            </span>
                            <a href="#" class="btn btn-md btn-danger demo-pli-trash fileupload-exists" title="Remove Attachment" data-dismiss="fileupload"></a>
                            <p class="help-block">Accepted Formats: pdf, jpg, jpeg and png</p>
                        </div>
            ...
            <label class="control-label">1.Vendor Questionnaire</label> 
                    ...
                    <div class="input-append">
                        ...
                        <span class="btn btn-md btn-mint fa fa-edit fileupload-exists" title="Change Attachment"></span>
                        <span class="fileupload-new btn btn-primary fa fa-upload"> Select file</span>
                        <input type="file" id="support_doc_1" name="support_doc_1" onchange="ValidateSingleInput(this);" required/>
                        </span>
                        <a href="#" class="btn btn-md btn-danger demo-pli-trash fileupload-exists" title="Remove Attachment" data-dismiss="fileupload"></a>
                    ...
                    <p class="help-block"><a href="../docs/Vendor Questionnaire.doc" target="_blank" class="text-info">Download: Vendor Questionnaire</a></p>
                </div>
                </div>
                ...
                <label class="control-label">2. Vendor Payee Setup Form</label> 
                    ...
                    <div class="input-append">
                        ...
                        <span class="btn btn-md btn-mint fa fa-edit fileupload-exists" title="Change Attachment"></span>
                        <span class="fileupload-new btn btn-primary fa fa-upload"> Select file</span>
                        <input type="file" id="support_doc_2" name="support_doc_2" onchange="ValidateSingleInput(this);" required/>
                        </span>
                        <a href="#" class="btn btn-md btn-danger demo-pli-trash fileupload-exists" title="Remove Attachment" data-dismiss="fileupload"></a>
                        <p class="help-block">.</p>
                    </div>
                    ...
                    <p class="help-block"><a href="../docs/Vendor Payee Set UP FORM.xlsx" target="_blank" class="text-info">Download: Vendor Payee Setup Form</a></p>
                </div>
                </div>
                ...
                <label class="control-label">3.</label> 
                    ...
                    <input type="text" class="form-control" name="support_doc_name_3" placeholder="Document Name" autocomplete="off">
                </div>
                </div>
            </div>
        </div>
...
$(document).on('nifty.ready', function() {
    ...
    $('#demo-bv-wz-form').bootstrapValidator({
        ...
        fields: {
		vendor_name: { validators: { notEmpty: { message: 'Company/Organisation Name is required' } } },
		registration_num: { validators: { notEmpty: { message: 'The Business Registration Number is required' } } },
        ...
        country: { validators: { notEmpty: { message: 'Country of Registration is required' } } },
        reg_cert: { validators: { notEmpty: { message: 'The Certificate of Registration is required' } } },
