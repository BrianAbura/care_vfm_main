...
$log->LogInfo("VENDOR_ORG_EMAIL_POST_DATA: ".print_r($verification,true));
}
?>
...
if(!empty($_REQUEST['user_verified_data_id'])){
    ...
    $log->LogInfo("VENDOR_ORG_EMAIL_VERIFY_DATA: ".print_r($verification,true));
    
    $home_url = "https://vfmplatform.com/care_vendors";
    $reset_pass_url = "https://vfmplatform.com/care_vendors/verify_changes.php?email=".$email;
    ...
    elseif($curDate > $check_link['expiry_date']){
        echo '<h3 style="color:#DC143C">EXPIRED '.$msg.' TOKEN....</h3> <strong>Please reset the password again..</strong>';
