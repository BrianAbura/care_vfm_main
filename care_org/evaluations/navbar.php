                ...
                <div class="navbar-content">
                    <ul class="nav navbar-top-links">
                        ...
                        <li class="tgl-menu-btn">
                            ...
                            <h4 class="page-header" style="color:#fff">Evaluations</h4>
                            </a>
                        </li>
        ...
        ?>
            ...
            <a href="../evaluations">
                ...
                <ul class="collapse in">
                    <li><a href="../evaluations">Quotations Received</a></li>
                    <li><a href="all_evaluations">Current Evaluations</a></li>
                    <li><a href="completed_evaluations">Completed Evaluations</a></li>
                </ul>
            </li>
