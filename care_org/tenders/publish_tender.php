...
<hr/>
<h4><span class="text-info"><i class="ion-upload icon-2x"></i></span> Tender Publication</h4><br/>
...
<input type="hidden" name="review_type" value="publish">
...
<div class="form-group">
    ...
    <p class="text-muted text-bold">Note: Adjust the Submission Deadline incase they had lapsed.</p>	
        <a href="../tenders/pending" class="btn btn-danger">Cancel</a>	
        <button type="submit" id="btnSaveDraft" name="formBtn" value="btnSave" class="btn btn-success">Publish Tender</button>
    </div>
</form>
</div>
