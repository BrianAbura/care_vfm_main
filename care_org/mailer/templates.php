...
function vendor_review_approval($vendor_name){
    $template = 
    '
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
...
<tr>
<td class="content-block">
<h3>Hello '.strtoupper($vendor_name).',</h3>
</td>
</tr>
<tr>
<td class="content-block">
<p>Your registration as a Care Uganda Vendor has been Approved.</p>
Please login to your account to view and respond to the any published tenders.
</td>
</tr>
<tr>
<td class="content-block">
<p>To login, visit <a href="https://vfmplatform.com/care_vendors/" target="_blank">Care Vendor Portal</a></p>
</tr>

<tr>
<td>
<p>Forgot your password? Click <a href="https://vfmplatform.com/care_vendors/password-reset" target="_blank">forgot password</a> to reset it.</p>
</tr>
</table>
</td>
</tr>
...
function vendor_review_hold($vendor_name){
    $template = '
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
...
<tr>
<td class="content-block">
<p>Your registration as a Care Uganda Vendor has been put on hold.</p>
Please wait for further instructions from Care Uganda.
</td>
</tr>
<tr>
<td class="content-block">
...
function vendor_review_rejection($vendor_name, $reason){
    $template = 
    '
    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <tr>
    <td class="content-block">
    <p>Your registration as a Care Uganda Vendor has been Rejected.</p>
    ...
    <tr>
    <td>
    <p>Please login to <a href="https://vfmplatform.com/care_vendors/" target="_blank">Care Vendor Portal</a> for more details.</p>
    <p>Forgot your password? Click <a href="https://vfmplatform.com/care_vendors/password-reset" target="_blank">forgot password</a> to reset it.</p>
    </tr>
    </table>
    </td>
...
function tender_publication_template($vendor_name, $title, $category, $method, $deadline){
    $template = '
    <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    ...
    <tr>
    <td class="content-block">
    <p>A new tender has been published on the portal.</p>
    Details:<br/>
    
    <i>Subject:</i> <b>'.$title.'</b><br/>
    <i>Category:</i> <b>'.$category.'</b><br/>
    <i>Procurement Method:</i> <b>'.$method.'</b><br/>
    <i>Submission Deadline:</i> <b>'.$deadline.' EAT</b>
    <br/><br/>
    </td>
    </tr>
    <tr>
    <td>
    <p>To participate login to <a href="https://vfmplatform.com/care_vendors/" target="_blank">Care Vendor Portal</a> for more details.</p>
    <p>Forgot your password? Click <a href="https://vfmplatform.com/care_vendors/password-reset" target="_blank">forgot password</a> to reset it.</p>
    </tr>
    </table>
    </td>
