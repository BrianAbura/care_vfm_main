...
<head>
    ...
    <title>Login Organisation User | Care Uganda</title>
		    ...
		    <div class="cls-content-sm panel">
		        <div class="panel-body">
		            <div class="mar-ver pad-btm">
		                <h1 class="h3 text-warning">Staff Login</h1>
...
?>
		        ...
		        <div class="pad-all text-left">
					...
					<hr/>
					<a href="../care_vendors/" class="text-semibold text-uppercase"><span class="text-mint">Vendor Login</span></a>
		        </div>
		    </div>
		</div>
    </div>
